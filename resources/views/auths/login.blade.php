...
<head>
	<title>Login | SMKN 2 Bangkalan</title>
	<meta charset="utf-8">
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{ asset('admin/logo-smkn2.png') }}" alt="Klorofil Logo"></div>
							...
							<form class="form-auth-small" action="/postlogin" method="post">
								...
								<div class="form-group">
									...
									<input name="email" type="email" class="form-control" id="signin-email" placeholder="Masukkan Email">
								</div>
								<div class="form-group">
